        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Heroes_Review_ReviewID",
                        column: x => x.ReviewID,
            ...
            migrationBuilder.InsertData(
                table: "Review",
                columns: new[] { "ID", "Review" },
                values: new object[,]
                {
                    { 1, "This character is awesome." },
                    { 21, "This character is awesome." },
                    { 20, "This character is awesome." },
                    { 19, "This character is awesome." },
                    { 18, "This character is awesome." },
                    { 17, "This character is awesome." },
                    { 16, "This character is awesome." },
                    { 15, "This character is awesome." },
                    { 14, "This character is awesome." },
                    { 13, "This character is awesome." },
                    { 12, "This character is awesome." },
                    { 10, "This character is awesome." },
                    { 9, "This character is awesome." },
                    { 8, "This character is awesome." },
                    { 7, "This character is awesome." },
                    { 6, "This character is awesome." },
                    { 5, "This character is awesome." },
                    { 4, "This character is awesome." },
                    { 3, "This character is awesome." },
                    { 2, "This character is awesome." },
                    { 11, "This character is awesome." }
                });

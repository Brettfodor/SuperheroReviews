...
namespace SuperHeroReviews.Repository
{
    public class HeroRepository : IRepository<HeroModel>
    {
        ...
        public HeroRepository()
        {
            ...
            heroList.Add(new HeroModel(1, "IronMan", "This character is awesome.", "Marvel", ""));

            heroList.Add(new HeroModel(2, "Thor", "This character is awesome.", "Marvel", ""));
            ...
            heroList.Add(new HeroModel(4, "Black Widow", "This character is awesome.", "Marvel", ""));

            heroList.Add(new HeroModel(5, "Black Panther", "This character is awesome.", "Marvel", ""));

            heroList.Add(new HeroModel(6, "Wolverine", "This character is awesome.", "Marvel", ""));

            heroList.Add(new HeroModel(7, "Thanos", "This character is awesome.", "Marvel", ""));

            heroList.Add(new HeroModel(8, "Antman", "This character is awesome.", "Marvel", ""));

            heroList.Add(new HeroModel(9, "Magneto", "This character is awesome.", "Marvel", ""));

            heroList.Add(new HeroModel(10, "Mystique", "This character is awesome.", "Marvel", ""));
            ...
            heroList.Add(new HeroModel(15, "Wonder Woman", "This character is awesome.", "DC", ""));
            ...
            heroList.Add(new HeroModel(17, "Superman", "This character is awesome.", "DC", ""));

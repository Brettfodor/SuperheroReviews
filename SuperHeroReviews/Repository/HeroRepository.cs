...
namespace SuperHeroReviews.Repository
{
    public class HeroRepository : IRepository<HeroModel>
    {
        ...
        public HeroRepository()
        {
            ...
            heroList.Add(new HeroModel(7, "Thanos", "This character is awesome.", "Marvel", "Thanos is the most evil villain in the Marvel universe", "/images/Thanoes.jpg"));
